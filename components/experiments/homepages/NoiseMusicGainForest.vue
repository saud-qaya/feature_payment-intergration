...
export default {
  ...
  data () {
    return {
      ...
      music_src: [window.location.origin + useRuntimeConfig().public.lagoon_src as string, window.location.origin + useRuntimeConfig().public.tropics_src as string, window.location.origin + useRuntimeConfig().public.forest_src as string, window.location.origin + useRuntimeConfig().public.meadow_src as string] as string[],
